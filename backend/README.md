...
## Project Structure
    ...
    ├── tst_appetize_versions_1  # Django project configurations
...
1. Clone this repo and `cd tst_appetize_versions_1`
...
2. Clone this repo and `cd tst_appetize_versions_1`
